...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'Built responsive website for Odd Studio Vision showcasing projects and services with interactive components, smooth navigation, and modern UI/UX.',
